...
filtered_data.to_excel:("metadata_extract_20260127_filtered.xlsx")


# saved (I copy and pasted this from perplexity ai as I couldn't find location of newly created file)

filtered_data.to_excel(r"C:\Users\46071956\Downloads\library_data_cleansing_activity_1\metadata_extract_20260127_filtered.xlsx", index=False)