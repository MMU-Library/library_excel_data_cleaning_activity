...
metadata_extract=pd.read_excel(r"C:\Users\46071956\Downloads\library_data_cleansing_activity_1\Outputs\metadata_extract_20260127_filtered.xlsx")
...
def standardise_date(value):
    try:
     return pd.to_datetime(str(value), dayfirst=True, format='mixed', errors='coerce').strftime("%d-%m-%Y")
    except:
        return value
...
metadata_extract.to_excel(r"C:\Users\46071956\Downloads\library_data_cleansing_activity_1\Outputs\metadata_extract_20260127_standardised_dates1.xlsx", index=False)
